...
<div class="container">
  ...
  <script>
    const chargers = [
             ...
             { name: "Apple 20W USB-C Power Adapter, Charger", price: "Rs 7,499.00", image: "product 99.webp" },
            { name: "Samsung 25W Travel charger Adapter (Super Fast Charger) - UK", price: "Rs 3,499.00", image: "product 100.webp" },
            { name: "MI 33W Wall Charger with Cable", price: "Rs 4,499.00", image: "product 101.webp" },
            { name: "Anker 322 USB-C to Lightning Cable (Series 3) Braided", price: "Rs 4,999.00", image: "product 102.webp" },
            { name: "Samsung 45W Type-C Travel Charger Adapter with Cable", price: "Rs 7,999.00", image: "product 103.webp" },
            { name: "Anker 322 USB-C to USB-C Cable (Series 3)", price: "Rs 1,499.00", image: "product 104.webp" },
            { name: "Google 30W USB-C Power Charger - 3 Pin UK Adapter", price: "Rs 7,299.00", image: "product 105.webp" },
            { name: "Xiaomi Mi 55W GaN Travel Charger (Adapter)", price: "Rs 5,999.00", image: "product 106.webp" },
            { name: "Anker Zolo 20W PD 3.0 Fast Adapter - A2699 (Charger)", price: "Rs 3,499.00", image: "product 107.webp" },
            { name: "Anker Zolo 30W Compact USB C GaN Charger Adapter (A2698)", price: "Rs 4,999.00", image: "product 108.webp" },
            { name: "Anker Charger PowerExtend Travel Adapter 30W With USB C Charger 312 ", price: "Rs 8,999.00", image: "product 109.webp" },
            { name: "Google 45W USB-C Power Charger (Adapter)", price: "Rs 9,999.00", image: "product 110.webp" },
            { name: "Anker Nano 100W Charger with 6ft 5A USB-C Cable", price: "Rs 14,999.00", image: "product 111.webp" },
            ];
